...
public class GameForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnl_MenuLayout.setVerticalGroup(
            ...
            .addGroup(pnl_MenuLayout.createSequentialGroup()
                ...
                .addComponent(jLabel2)
                .addGap(5, 5, 5)
                .addComponent(txfRoomId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel3)
                .addGap(3, 3, 3)
    ...
    private void btncreateRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncreateRoomActionPerformed
        pnl_Table.isServer = true;
        this.btnJoin.setEnabled(false);
        this.btncreateRoom.setEnabled(false);
        pnl_Table.actionPerformed(evt);
    }//GEN-LAST:event_btncreateRoomActionPerformed

    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        pnl_Table.started = true;
        pnl_Table.isServer = true;
        pnl_Table.actionPerformed(evt);
    }//GEN-LAST:event_btnStartActionPerformed

    private void btnJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJoinActionPerformed
        pnl_Table.isClient = true;
        pnl_Table.isServer = false;
        this.btncreateRoom.setEnabled(false);
        pnl_Table.actionPerformed(evt);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                gameForm.setLocation(center.x - (gameForm.getWidth() / 2), center.y - (gameForm.getHeight() / 2));
            }
        });
    }
